...
let postTaxPrices = prices.map(function(a) {
  return a*1.07;
});
...
let myStrongest = monstersInYourPocket.filter(function(a){
  return a['CP']>200;
});
...
bobsTotal = bobsTotal.reduce(function(sum, purchaseObj['price']){
